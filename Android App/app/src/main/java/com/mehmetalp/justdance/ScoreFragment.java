...
public class ScoreFragment extends Fragment {
    ...
    ArrayList<com.mehmetalp.justdance.models.Score> dataModels;
    ListView listView;
                ...
                try {
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            databaseOrders = FirebaseDatabase.getInstance().getReference("score").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                            ...
                            databaseOrders.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    adapter = new ScoreAdapter(scoreList, getActivity().getBaseContext());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter= new ScoreAdapter(scoreList,getActivity());
