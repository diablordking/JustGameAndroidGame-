...
public class CameraActivity extends AppCompatActivity implements UploadFragment.OnFragmentInteractionListener {
    ...
    private void openCamera(int cameraType) {
        ...
        try {
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED &&
                ...
                ActivityCompat.requestPermissions(CameraActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.RECORD_AUDIO}, REQUEST_CAMERA_PERMISSION);
                return;
            }
        ...
        try {
            ...
            mMediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener(){
                                                 @Override public void onInfo(    MediaRecorder mr,    int what,    int extra){
                                                     Log.e("Deneme:", ""+MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED);
                                                     Log.e("What:", what+"");
                                                     if (what!=800) {
                                                         stopRecordingVideo();
                                                     }
...
//        transaction.commit();
    ...
    //        mMediaRecorder.setVideoSize(mVideoSize.getWidth(), mVideoSize.getHeight());
            ...
            switch (mSensorOrientation) {
                case SENSOR_ORIENTATION_DEFAULT_DEGREES:
                    mMediaRecorder.setOrientationHint(DEFAULT_ORIENTATIONS.get(270));
                    break;
                case SENSOR_ORIENTATION_INVERSE_DEGREES:
                    mMediaRecorder.setOrientationHint(INVERSE_ORIENTATIONS.get(270));
                    break;
            }
    ...
    private void stopRecordingVideo() {
        ...
        Toast.makeText(CameraActivity.this, "Video saved: " + file.toString(),
